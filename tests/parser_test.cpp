...
void test_SLR() {
  ...
  Item i0(AUGMENTED_START, v0, DNE);
  ...
  Item i1(AUGMENTED_START, v1, DNE);
  Item i2(G.serialize("E"), v2, DNE);
  ...
  Item i3(G.serialize("E"), v3, DNE);
  Item i4(G.serialize("T"), v4, DNE);
  ...
  Item i10(G.serialize("E"), v10, DNE);
  Item i11(G.serialize("F"), v11, DNE);
  ...
  Item i12(G.serialize("E"), v12, DNE);
  Item i13(G.serialize("T"), v13, DNE);
  ...
  Item i14(G.serialize("T"), v14, DNE);
  ...
  Item i15(G.serialize("F"), v15, DNE);
...
void test_LALR_automaton() {
  ...
  Item i0(AUGMENTED_START, v0, ACCEPT);
  s0.items.push_back(&i0);
  ...
  Item i1(AUGMENTED_START, v1, ACCEPT);
  s1.items.push_back(&i1);
  ...
  Item i2(G.serialize("S"), v2, ACCEPT);
  Item i3(G.serialize("R"), v3, ACCEPT);
  ...
  Item i4(G.serialize("S"), v4, ACCEPT);
  ...
  Item i5(G.serialize("L"), v5, ACCEPT);
  Item i6(G.serialize("L"), v6, G.serialize("="));
  ...
  Item i7(G.serialize("L"), v7, ACCEPT);
  Item i8(G.serialize("L"), v8, G.serialize("="));
  s5.items.push_back(&i7);
  ...
  Item i9(G.serialize("S"), v9, ACCEPT);
  ...
  Item i10(G.serialize("L"), v10, ACCEPT);
  Item i11(G.serialize("L"), v11, G.serialize("="));
  ...
  Item i12(G.serialize("R"), v12, ACCEPT);
  Item i13(G.serialize("R"), v13, G.serialize("="));
  ...
  Item i14(G.serialize("S"), v14, ACCEPT);
...
void test_LALR_actionTable() {
  ...
  std::cout << lalr.actionTable.size() << std::endl;
}
// void test_LALR() {
//   std::ifstream file( "./grammar.txt");
//   if (!file) assert(false);
